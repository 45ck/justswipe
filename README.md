...
After hosted quota resets, use `npm run bridge:e2e-hosted -- --app-url https://clear-harbor-b4fc257b5a.lakebed.app --timeout-ms 300000` for the same proof against the hosted app.
